          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={notificationRef}>
              <button
                ...
                className={`
                  ...
                  ${isNotificationsOpen ? 'bg-indigo-50 text-indigo-600' : 'bg-gray-100 hover:bg-gray-200'}
                `}
              >
              ...
              {isNotificationsOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-2 border border-gray-100 transform transition-all duration-200 ease-out">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    ...
                    <div className="px-4 py-3 hover:bg-gray-50">
                      <p className="text-sm text-gray-600">New event has been added</p>
            ...
            <div className="relative" ref={profileRef}>
              <button
                ...
                ${isProfileOpen ? 'transform scale-105 ring-2 ring-indigo-500' : 'hover:scale-105'}
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl py-2 transform transition-all duration-200 ease-out">
                  ...
                  <div className="py-1">
                    ...
                    <Link
                      ...
                      className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 transition-colors duration-150"
                    >
                      <svg className="w-5 h-5 mr-3 text-gray-400" fill="none" viewBox="0 24 24" stroke="currentColor">
