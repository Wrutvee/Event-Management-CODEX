...
export default function CreateEvent() {
  ...
  const validateForm = () => {
    ...
    // Organizer Details
    if (!formData.organizer.name.trim()) errors.push("Organizer name is required");
    if (!formData.organizer.email.trim()) errors.push("Organizer email is required");
    if (!formData.organizer.contact.trim()) errors.push("Contact number is required");
    ...
    if (formData.registration.isRequired) {
      ...
      if (formData.registration.additionalInfo.required && 
