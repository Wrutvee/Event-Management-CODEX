          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <div className="flex-shrink-0 flex items-center">
                <img className="h-7 md:h-8 w-auto" src="/logos/main_logo.png" alt="Logo" />
                <span className="ml-2 text-lg md:text-xl font-bold text-gray-800">EventHub</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center md:space-x-2 lg:space-x-4">
              ...
              >
                <svg className={`mr-1.5 lg:mr-2 h-4 lg:h-5 w-4 lg:w-5 ${
